...
public class MineManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        InstantiateMine(basicMines, "Basic");
        InstantiateMine(medumMines, "Medium");
        InstantiateMine(advancedMines, "Advanced");
    ...
    private void InstantiateMine(int amount, string type)
    {
